...
const FeatureCard = ({ icon: Icon, title, description, delay }: { icon: any, title: string, description: string, delay: number }) => (
    <motion.div
        ...
        viewport={{ once: true }}
        className="glass-panel p-8 flex flex-col items-start gap-4"
    >
...
export const Home = () => {
    return (
        <div className="flex flex-col items-center">
            {/* ── HERO SECTION ── */}
            <section className="section-container text-center pt-20 pb-32">
                <motion.div
                ...
                >
                    ...
                    <h1 className="text-6xl md:text-8xl font-bold tracking-tight text-slate-900 dark:text-white leading-[1.1]">
            ...
            {/* ── FEATURES GRID ── */}
            <section className="w-full max-w-6xl mx-auto px-6 grid grid-cols-1 md:grid-cols-3 gap-6 pb-32">
                <FeatureCard
                    icon={Brain}
                    title="Predictive AI"
